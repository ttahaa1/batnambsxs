...
※ استخدم الازرار لمعرفه الاوامر المستخدمه. """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("🔱 𝐒𝐎𝐔𝐑𝐂𝐄 ᗷᒪᗩᑕK 🔱", url=f"https://t.me/YTYT_TY"),
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    InlineKeyboardButton(
                        "‹ السورس ›", url=f"https://t.me/YTYT_TY"
                    ),
                    InlineKeyboardButton(
                        "‹ اضف البوت لمجموعتك ›", url=f"https://t.me TetrisBot5bot?startgroup=true"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "‹ الدعم ›", url="https://t.me/z_gsx"
                    )
                ],
            ]
        ),
...
InlineKeyboardButton(" member keyboard ", callback_data="Q_XUQ"),
                ...
                [
                    InlineKeyboardButton(
                        "🔱 𝐒𝐎𝐔𝐑𝐂𝐄 ᗷᒪᗩᑕK 🔱", url=f"https://t.me/YTYT_TY"
                    ),
                    InlineKeyboardButton(
                        "‹ المطور ›", url=f"https://t.me/TT_11_TY"
                    ),
                ],
                [
                    InlineKeyboardButton(

...
API_ID = int(getenv("API_ID","25095609"))
API_HASH = getenv("API_HASH","44e5fdcafc8fbf598fae875860de2850")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("7119829105:AAFdwrgeVx28Zun-9xKWcKOZ2rp_uPH2vSw")
...
LOGGER_ID = int(getenv("6308626584"))

# Get this value from @FallenxBot on Telegram by /id
OWNER_ID = int(getenv("6739845954", 6739845954))
